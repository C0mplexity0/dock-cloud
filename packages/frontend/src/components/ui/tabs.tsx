...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-full items-center gap-1 rounded-t-lg bg-background-secondary p-2 text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "",
...
function TabsContent({ className, ...props }: TabsPrimitive.Panel.Props) {
  return (
    <TabsPrimitive.Panel
      ...
      className={cn(
        "-b3 flex-1 rounded-b-lg bg-background-secondary p-4 pt-2 text-sm outline-none",
        className
      )}
      {...props}
    />
